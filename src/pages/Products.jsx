    ...
    <div className="container mx-auto px-4 py-8 transition-colors">
      <div className="mb-8">
        <div className="flex flex-col md:flex-row justify-center items-center gap-4 mb-4">
          ...
          <button onClick={() => setFiltersVisible(!filtersVisible)} className="flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-300" style={{ backgroundColor: "var(--color-secondary)", color: "var(--color-text)" }}>
            <Funnel size={18} />
            Filters
        ...
        {filtersVisible && (
          <div className="flex justify-center">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 p-4 rounded-lg transition-all md:w-auto" style={{ backgroundColor: "var(--color-accent)" }}>
              <div>
